...
public class FileUploadService {
    ...
    public void uploadFiles(User.UserType userType, String projectName, List<MultipartFile> files) throws IOException {
        ...
        Path projectDir = Paths.get(uploadBasePath, projectName);
    ...
    public void uploadJobDescription(String projectName, String description) throws IOException {
